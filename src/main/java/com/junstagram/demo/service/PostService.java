...
import com.junstagram.demo.web.dto.post.*;
...
public class PostService {
    ...
    public PostInfoDto getPostInfoDto(Long postId, Long sessionId) {
        ...
        postInfoDto.setPostImgUrl(post.getPostImageUrl());
    ...
    public PostDto getPostDto(Long postId) {
        ...
        return PostDto.builder()
                ...
                .tag(post.getTag())
                .text(post.getText())
                .postImgUrl(post.getPostImageUrl())
                .build();
    }
    ...
    public void delete(Long postId) {
        ...
        File file = new File(uploadUrl + post.getPostImageUrl());
        file.delete();
